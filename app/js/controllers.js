...
vivoviz.factory('SkillsGetHttp', function ($http) {
    ...
    $http({
        ...
        headers: {"Accept": "application/sparql-results+json", 'Content-type': 'application/x-www-form-urlencoded'}
            ...
            return "Fuseki returned: " + status;//need to make an if statement for the SkillsCtrl
        });

    $scope.orderProp = "Person.value";
});
vivoviz.SkillsCtrl = function($scope, SkillsGetHttp) {
    $scope.skills = SkillsGetHttp;
    $scope.orderProp = "Person.value";
}
;

vivoviz.AddSkillCtrl = function($scope, $http, $timeout, $filter) {
